...
export default function LoginPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (success) {
      // Get user type from auth context to redirect appropriately
      ...
      setError("Invalid credentials. Try demo accounts: consumer@demo.com, brand@demo.com, or admin@demo.com (password: demo123)");
    }
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center text-gray-600">
                <input 
                  type="checkbox" 
                  className="mr-2 w-4 h-4 rounded border-gray-300 text-black focus:ring-black" 
                />
                Remember me
              </label>
