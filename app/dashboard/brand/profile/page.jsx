...
import { getBrands } from "@/lib/brandStorage";
...
export default function BrandProfilePage() {
  ...
  useEffect(() => {
    ...
    const foundBrand = brands.find((b) => b.email === user.email);
    ...
    if (foundBrand) {
      ...
      setFormData({
        ...
        facebook: foundBrand.facebook || "",
        instagram: foundBrand.instagram || "",
  ...
  const handleSubmit = (e) => {
    ...
    try {
      // Get all brands
      const brands = getBrands();
      const brandIndex = brands.findIndex((b) => b.email === user?.email);
      ...
      if (brandIndex !== -1) {
        ...
        localStorage.setItem("vto_brands", JSON.stringify(brands));
  ...
  if (!isAuthenticated || !user || user.type !== "brand") {
    return (
      <div className="min-h-screen bg-light-gray flex items-center justify-center">
        <div className="w-14 h-14 rounded-full border-4 border-light-gray border-t-black animate-spin" />
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-light-gray">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold mb-2">Brand Profile</h1>
          <p className="text-medium-gray">
            Manage your brand information and social media links
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {formData.logo && (
                  <div className="mt-3">
                    <p className="text-sm text-medium-gray mb-2">Logo Preview:</p>
                    <img 
                      src={formData.logo} 
          ...
          <div className="card">
            <h2 className="text-2xl font-bold mb-6">Website & Social Media</h2>
